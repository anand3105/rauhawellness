...
export default function KumukadiOilPage() {
  try {
    return (
      <main className="min-h-screen pt-16 sm:pt-20 bg-rauha-light">
            ...
            <div className="relative aspect-square bg-gradient-to-br from-rauha-taupe/40 to-rauha-accent/20 rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  <Droplet className="w-20 h-20 sm:w-32 sm:h-32 text-rauha-accent mx-auto mb-3 sm:mb-4 opacity-60" />
                  <p className="text-rauha-text font-medium text-sm sm:text-base">Product Image</p>
                </div>
              </div>
    ...
    return (
      <main className="min-h-screen pt-16 sm:pt-20 bg-rauha-light flex items-center justify-center px-4">
        <div className="text-center">
